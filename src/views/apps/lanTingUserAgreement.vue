<template>
    <div id='main'>
        ...
        <p class="section">
            1、用户在使用本服务前需要注册一个“澜渟”帐号。“澜渟”帐号应当使用手机号码绑定注册，请用户使用尚未与“澜渟”帐号绑定的手机号码，
            以及未被麦豆根据本协议封禁的手机号码注册“澜渟”帐号。麦豆可以根据用户需求或产品需要对帐号注册和绑定的方式进行变更，
            而无须事先通知用户。
        </p>
        <p class="section">
            2、“澜渟”是基于地理位置的移动社交产品，用户注册时应当授权麦豆公开及使用其地理位置信息方可成功注册“澜渟”帐号。
            故用户完成注册即表明用户同意麦豆提取、公开及使用用户的地理位置信息。如用户需要终止向其他用户公开其地理位置信息，可自行设置为隐身状态。
        </p>
        <p class="section">
            3、鉴于“澜渟”帐号的绑定注册方式，您同意麦豆在注册时将使用您提供的手机号码或自动提取您的手机设备识别码等信息用于注册。
        </p>
        <p class="section">
        ...
        <p class="section">
            ...
            任何18岁以下的用户不得下载和使用麦豆通过澜渟软件提供的网络游戏。
        </p>
        <p class="section">
            7、用户确认，其地理位置信息为非个人隐私信息，用户成功注册“澜渟”帐号视为确认授权麦豆提取、公开及使用用户的地理位置信息。
        ...
        <p class="section">
            2、用户不得利用“澜渟”帐号或本服务制作、上载、复制、发布、传播如下法律、法规和政策禁止的内容：<br/>
            (1) 反对宪法所确定的基本原则的；<br/>
        ...
        <p class="section">
            3、用户不得利用“澜渟”帐号或本服务制作、上载、复制、发布、传播如下干扰“澜渟”正常运营，
        ...
        <p class="section">
            1、“澜渟”帐号的所有权归麦豆所有，用户完成申请注册手续后，获得“澜渟”帐号的使用权，该使用权仅属于初始申请注册人，
            禁止赠与、借用、租用、转让或售卖。麦豆因经营需要，有权回收用户的“澜渟”帐号。
        </p>
        <p class="section">
            2、用户可以更改、删除“澜渟”帐户上的个人资料、注册信息及传送内容等，但需注意，
        ...
        <p class="section">
            ...
            麦豆在通知用户后有权依据协议中断或终止对违约用户“澜渟”帐号提供服务。同时，麦豆保留在任何时候收回“澜渟”帐号、用户名的权利。
        </p>
        <p class="section">
            5、如用户注册“澜渟”帐号后一年不登录，通知用户后，麦豆可以收回该帐号，以免造成资源浪费，由此造成的不利后果由用户自行承担。
        </p>
        ...
        <p class="section">
            1、用户理解并同意，“澜渟”仅为用户提供信息分享、传送及获取的平台，用户必须为自己注册帐号下的一切行为负责，
            包括用户所传送的任何内容以及由此产生的任何后果。用户应对“澜渟”及本服务中的内容自行加以判断，
        ...
        <p class="section">
            5、用户理解并确认，麦豆需要定期或不定期地对“澜渟”平台或相关的设备进行检修或者维护，
        ...
        <p class="section">
            ...
            包括因用户使用“澜渟”或本服务而遭受的利润损失，承担责任（即使麦豆已被告知该等损失的可能性亦然）。
